The Norwegian Public Roads Administration's Traffic Data API contains traffic data from public roads in Norway.
...
Read more on traffic data and data quality under <a href="#/about/1-om-trafikkdata"  style="color: #44f55; text-decoration: underline;">Om trafikkdata (Norwegian only)</a>.

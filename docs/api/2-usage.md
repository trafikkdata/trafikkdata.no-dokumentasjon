...
The Traffic Data API uses GraphQL, which is a data query language for APIs.
...
There are two ways to use the API, depending on your needs:

- **Web interface (GraphiQL):** If you want to explore the data, write queries and see the results directly in your browser, go to <a href="https://trafikkdata.no/graphql"  style="color: #44f55; text-decoration: underline;">trafikkdata.no/graphql</a>. This is the easiest way to get started.
- **Direct API access:** If you want to fetch data from your own application or script, send requests directly to <a href="https://trafikkdata-api.atlas.vegvesen.no"  style="color: #44f55; text-decoration: underline;">https://trafikkdata-api.atlas.vegvesen.no</a>. See the <a href="#examples">examples</a> below for how to do this in JavaScript and curl.

For more information on programmatic access from different programming languages, visit <a href="https://graphql.org/code/"  style="color: #44f55; text-decoration: underline;">graphql.org/code</a>. 

In the following, we present a few examples of API queries.
For full documentation of all available queries and fields, use the <a href="https://trafikkdata.no/graphql"  style="color: #44f55; text-decoration: underline;">GraphiQL interface</a> and click on `Docs`.

### Traffic registration points

A traffic registration point is a location on the road where traffic is registered. For more information, see <a href="#/about/1-om-trafikkdata"  style="color: #44f55; text-decoration: underline;">Om trafikkdata</a>. 
...
<a href="https://trafikkdata.no/graphql?query=%7B%0A%20%20trafficData(trafficRegistrationPointId%3A%20%2244656V72812%22)%20%7B%0A%20%20%20%20volume%20%7B%0A%20%20%20%20%20%20byHour(from%3A%20%222019-10-24T12%3A00%3A00%2B02%3A00%22%2C%20to%3A%20%222019-10-24T14%3A00%3A00%2B02%3A00%22)%20%7B%0A%20%20%20%20%20%20%20%20edges%20%7B%0A%20%20%20%20%20%20%20%20%20%20node%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20from%0A%20%20%20%20%20%20%20%20%20%20%20%20to%0A%20%20%20%20%20%20%20%20%20%20%20%20total%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20volumeNumbers%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20volume%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20coverage%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20percentage%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D" style="color: #44f55; text-decoration: underline;"> Open query in GraphiQL</a>
